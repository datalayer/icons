...
const icons = {
  ...
  Dask: DaskLogoIcon,
  Datalayer: DatalayerLogoIcon,
  DatalayerBlack: DatalayerLogoBlackIcon,
  DatalayerColor: DatalayerLogoColorIcon,
  DatalayerGreen: DatalayerLogoGreenIcon,
  ...
  JupyterMyst: JupyterMystLogoIcon,
