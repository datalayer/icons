...
const DaskLogoIcon = (
  ...
  return (
    <Icon {...props} viewBox="0 0 512 512">
      <g>
        <path fill="#FFC11E" d="M143.71,157.61l126.5-72.99c1.25-0.72,2.02-2.05,2.02-3.5l0.01-43.77c0-6.48-2.66-12.9-7.83-16.81
          ...
          z"/>
        <path fill="#EF1161" d="M446.95,124.53c-3.15-1.82-6.61-2.73-10.06-2.73c-3.45,0-6.9,0.91-10.05,2.73l-176.96,102.1
        ...
        <path fill="#FC6E6B" d="M240.95,211.14l116.78-67.38c1.25-0.72,2.02-2.05,2.02-3.5l0.02-50.98c0-6.48-2.66-12.9-7.83-16.81
